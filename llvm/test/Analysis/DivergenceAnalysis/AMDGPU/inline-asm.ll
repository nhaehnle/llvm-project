...
; RUN: opt -disable-output -mtriple=amdgcn-unknown-amdhsa -mcpu=tahiti -passes="print<uniforminfo>" %s 2>&1 | FileCheck %s
; RUN: opt -disable-output -mtriple=amdgcn-unknown-amdhsa -mcpu=gfx908 -passes="print<uniforminfo>" %s 2>&1 | FileCheck %s
