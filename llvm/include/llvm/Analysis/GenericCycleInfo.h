...
public:
  ...
  bool isEntry(BlockRef block) const {
    return GenericCycleBase::isEntry(CfgTraits::toGeneric(block));
  }
  BlockRef getHeader() const {
    return CfgTraits::fromGeneric(GenericCycleBase::getHeader());
  }
  bool containsBlock(BlockRef block) const {
    return GenericCycleBase::containsBlock(CfgTraits::toGeneric(block));
  }
  ...
  Printable printEntries() const {
    return Printable([&](raw_ostream &out) {
      out << GenericCycleBase::printEntries(
          CfgPrinterImpl<CfgTraits>(
              CfgInterfaceImpl<CfgTraits>(
                  CfgTraits::getBlockParent(getHeader()))));
    });
  }
  Printable print() const {
    return Printable([&](raw_ostream &out) {
      out << GenericCycleBase::print(
          CfgPrinterImpl<CfgTraits>(
              CfgInterfaceImpl<CfgTraits>(
                  CfgTraits::getBlockParent(getHeader()))));
    });
...
public:
  ...
  void compute(BlockRef entryBlock) {
    GenericCycleInfoBase::compute(
        ...
        CfgTraits::toGeneric(entryBlock));
  }

  void splitBlock(BlockRef oldBlock, BlockRef newBlock) {
    GenericCycleInfoBase::splitBlock(CfgTraits::toGeneric(oldBlock),
                                     CfgTraits::toGeneric(newBlock));
  }
  ...
  Cycle *getCycle(BlockRef block) {
    return static_cast<Cycle *>(
        GenericCycleInfoBase::getCycle(CfgTraits::toGeneric(block)));
  }
  ...
  auto findExitBlocks(const Cycle *cycle,
    ...
    return CfgTraits::unwrapRange(GenericCycleInfoBase::findExitBlocks(
        CfgInterfaceImpl<CfgTraits>(
            CfgTraits::getBlockParent(cycle->getHeader())), cycle, tmpStorage));
  }
