...
public:
  ...
  iterator_range<iterator> generic_children() {
    return make_range(generic_begin(), generic_end());
  }
...
public:
  DomTreeNodeBase(NodeT *BB, DomTreeNodeBase *IDom)
      : GenericDomTreeNodeBase(CfgTraits::toGeneric(BB), IDom) {}
  ...
  NodeT *getBlock() const { return CfgTraits::fromGeneric(TheBB); }
...
public:
  ...
  TreeNode *getNode(const NodeT *BB) const {
    return static_cast<TreeNode *>(GenericDominatorTreeBase::getNode(
        CfgTraits::toGeneric(const_cast<NodeT *>(BB))));
  }
  ...
  void eraseNode(NodeT *BB) {
    ...
    DomTreeNodes.erase(CfgTraits::toGeneric(BB));
